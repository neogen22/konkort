...
<template>
  <div class="">
    <h1 class="text-black text-2xl text-center mt-6">Реклама на телеканале "КтвК"</h1>
    ...
    <p class="mt-2 text-justify">Минимальная оплата за однодневную рекламу - 1000 рублей.</p>
