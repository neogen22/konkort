...
<template>
  ...
  <h2 class="text-white text-xl text-center mt-4 font-semibold">
  ...
  <h2 class="text-white text-xl text-center mt-6 font-semibold">
  ...
  <h1 class="!text-orange-400 text-justify mt-4">
