...
<template>
  <div class="">
    <h1 class="text-black text-2xl text-center mt-4">Реклама на телеканале "КтвК"</h1>
    ...
    <p class="text-justify mt-4">Почему реклама на телевидении эффективна?</p>
    <div class="mt-2 smartphone-table">
      ...
      <p class="text-justify selected indent-1 mt-2">
      ...
      <p class="text-justify selected indent-1 mt-2">наибольшая возможность удерживать внимание;</p>
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
        height="24"
      ...
      <p class="text-justify selected indent-1 mt-2">запоминаемость;</p>
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
        height="24"
      ...
      <p class="text-justify selected indent-1 mt-2">безграничные варианты подачи;</p>
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
        height="24"
    ...
    <table class="advertising-top mt-2 non-smartphone-table">
      <tr>
        ...
        <td style="vertical-align: top">
          <p class="text-justify selected">наибольшая возможность удерживать внимание;</p>
        </td>
      </tr>
      <tr>
        <td width="39px" style="vertical-align: top">
      ...
      <tr>
        ...
        <td style="vertical-align: top">
          <p class="text-justify selected">запоминаемость;</p>
        </td>
      </tr>
      <tr>
        <td width="39px" style="vertical-align: top">
        ...
        <td style="vertical-align: top">
          <p class="text-justify selected">безграничные варианты подачи;</p>
        </td>
      </tr>
      <tr>
        <td width="39px" style="vertical-align: top">
    ...
    <h2 class="text-black text-xl text-center font-semibold">(с 01.03.2019 года)</h2>
    <Table class="mt-4"
      ><TableHeader>
        <TableRow>
    ...
    <h1 class="text-black text-justify mt-4">
      <span class="underline underline-offset-4">Реклама на телевидении</span> - идеальное средство
      для демонстрации имиджа, продукта и услуг Вашей компании. Наибольшую эффективность рекламы на
      ТВ обеспечивает комплексное решение. Мы сделаем так, чтобы Вас обязательно увидели!
    </h1>
  </div>
</template>
<style scoped>
...
.advertising-top tr td {
  height: 35px;
}
.advertising-top tr td:first {
  vertical-align: top;
}
@media (width >= 500px) {
