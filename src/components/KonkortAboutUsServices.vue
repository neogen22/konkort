  ...
  <div class="background-with-opacity">
    ...
    <div class="smartphone-table pl-2">
      <div class="flex mt-2">
        ...
        <p class="indent-7 text-justify text-orange-400 p-for-animation-1">цифровое телевидение;</p>
      </div>
      <div class="flex mt-2">
        <svg
          class="fill-orange-400 float-left absolute svg-2"
          xmlns="http://www.w3.org/2000/svg"
          width="24"
          height="24"
          viewBox="0 0 16 16"
  ...
  <div class="background-with-opacity max-w-[520px]">
    ...
    <table class="advertising-top non-smartphone-table pl-2">
      <tr>
        ...
        <td class="align-top">
          <p class="text-justify text-orange-400 p-for-animation-3">
